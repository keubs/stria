...
jQuery('.wvi_img').on('click', function() {
  var data_radio_id = jQuery(this).data('radio_id');
	//console.log(data_radio_id);
  var input_obj = jQuery("input[id='"+data_radio_id+"']");
	//console.log(jQuery(input_obj).val());
	jQuery(input_obj).prop('checked', true).trigger("change");
	jQuery(input_obj).prop('checked', true).trigger("click");
} );

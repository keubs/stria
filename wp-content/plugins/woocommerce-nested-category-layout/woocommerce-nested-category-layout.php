...
SV_WC_Framework_Bootstrap::instance()->register_plugin( '4.6.0', __( 'WooCommerce Nested Category Layout', 'woocommerce-nested-category-layout' ), __FILE__, 'init_woocommerce_nested_category_layout', array(
